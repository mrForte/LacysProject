...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ...
    public CategoryAdapter(String Titles[], int Icons[], String Name, String Email, Context passedContext){ // CategoryAdapter Constructor with titles and icons parameter
